...
<div class="container mt-5">
    ...
    <form action="/asm/sp/update" method="post">
        <div class="mb-3">
            <label for="idSanPham" class="form-label">ID Sản Phẩm</label>
            <input type="text" class="form-control" id="idSanPham" name="idSanPham" value="${sp.idSanPham}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="trangThai" id="on"
                       value="true" ${sp.trangThai ? 'checked' : ''}>
                <label class="form-check-label" for="on">On</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="trangThai" id="off"

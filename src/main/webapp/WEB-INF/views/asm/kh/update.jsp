...
<div class="row justify-content-center">
    <div class="col-md-8 form-container">
        ...
        <form:form action="/asm/kh/update" method="post" modelAttribute="khachHang" cssClass="needs-validation"
                   novalidate="novalidate">
            <!-- Trường Hiển Thị ID Khách Hàng với readonly -->
            <div class="row mb-3">
                <label for="idKhachHang" class="col-sm-3 col-form-label">ID Khách Hàng</label>
                <div class="col-sm-9">
                    <!-- Hiển thị ID Khách Hàng trong một thẻ span -->
                    <span id="idKhachHang" class="form-control-plaintext">${khachHang.idKhachHang}</span>
                    <input type="hidden" name="idKhachHang" value="${khachHang.idKhachHang}"/>
                    <form:errors path="idKhachHang" cssClass="text-danger"/>
                </div>
            </div>
